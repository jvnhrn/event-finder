            ...
            <div {...getRootProps({ className: 'dropzone' }) } class=" flex justify-center container px-6 py-6 border-2 border-gray-300 border-dashed rounded-full" >
                <div class="space-y-1 text-center">
                    ...
                    <div class="mb-6 pt-3 rounded">
                        ...
                        <input onChange={(e) => set_user_birthdate(e.target.value)} type="date" id="password3" class="tracking-tighter bg-gray-100 text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-blue-600 transition duration-500 px-3 py-2" />
                    </div>
