...
import artsncraft from '../Random/arts and craft.jpg';
import drawing from '../Random/drawing.png';
import knitting from '../Random/knitting.png';
    ...
    return (
        ...
        <div class="px-10 py-10 flex">
            ...
            <div class ="max-w-sm rounded-3xl overflow-hidden shadow-lg mr-10">
                <img src={artsncraft} alt="artsncraft"/>  
