...
import hotpodyoga from '../images/yoga/hotpodyoga.png';
import stretchyoga from '../images/yoga/stretchyoga.jpg';
import namaste from '../images/yoga/namaste.png';
import flexing from '../images/yoga/flexing.gif';
        ...
        <div class="px-10 py-10 flex">
            ...
            <div class ="max-w-sm rounded-3xl overflow-hidden shadow-lg mr-10">
                ...
                <div className="px-12 py-4">
                    ...
                    <p className="text-gray-400 text-left tracking-tighter mb-4" id= "address">Rudlplatz 5 1100, Vienna</p>
