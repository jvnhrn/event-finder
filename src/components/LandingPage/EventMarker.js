...
function EventMarker(props) {
  ...
  return (
    <div className="opacity-50">
      <Marker
        position={[
          Number(props.event_gps_latitude),
          Number(props.event_gps_longitude),
        ]}
        icon={newIcon}
      ...
      >
        <Popup
          className="bbg-gray-100 opacity-50"
          onOpen={() => {
          ...
          <div className="w-64">
            ...
            <div className="text-sm text-gray-400 my-4 text-left tracking-tighter">
              <div>
                <b>STARTS:</b>{" "}
                {(
                  new Date(props.event_start_date) +
            ...
            <div className="text-sm text-gray-400 my-4 text-left tracking-tighter">
              <span>{props.event_description}</span>
            </div>
