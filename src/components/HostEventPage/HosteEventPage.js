    ...
    return (
        <div className="px-10 ">
            ...
            <div class="grid grid-cols-4 gap-4 object-center">
                ...
                <div class=" outline-none mt-7 pt-6">
                    <select onChange={(e) => { setEvent_location(e.target.value) }} id="location" name="" class="tracking-tighter bg-gray-100 container mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text" placeholder="location">
                ...
                event starts at {' '}
                    <input onChange={(e) => { setEvent_start_date(e.target.value) }} type="datetime-local" id="date" name="event_date"
                        ...
                        min="2021-01-17" max="2100-12-31" class="bg-gray-100 container rounded-md px-4 py-2 focus:ring-purple-600 outline-none " />
                </div>
