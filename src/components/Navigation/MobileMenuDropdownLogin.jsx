          ...
          <div
            className={
              (props.openLoginModal
                ? "hidden"
                : "mx-auto mt-2 w-60 rounded-md shadow-lg py-2 bg-white") +
              (props.openRegisterModal
                ? "hidden"
                : "mx-auto mt-2 w-48 rounded-md shadow-lg py-2 bg-white")
            }
          >
            {/* Login/ Sign Up*/}
            <div class="text-center mb-2">
              <button
                ...
                className={
                  (props.openLoginModal
                    ? "bg-purple-600 hover:bg-purple-800 active:bg-purple-900 text-white text-md font-bold uppercase py-3 px-6 rounded shadow-lg hover:shadow-xl outline-none focus:outline-none transition duration-200"
                    : "bg-purple-600 hover:bg-purple-800 active:bg-purple-900 text-white text-md font-bold uppercase py-3 px-6 rounded shadow-lg hover:shadow-xl outline-none focus:outline-none transition duration-200") +
                  (props.openRegisterModal
                    ? "hidden"
            ...
            <div class="max-w-lg mx-auto text-center mt-4 mb-2">
              <p class="block px-4 text-sm text-gray-700">
