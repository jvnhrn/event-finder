            ...
            <div class="block bg-gray-800">
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    ...
                    <div class="mt-3 px-2 space-y-1">
                        ...
                        <button class="w-1/2 p-2 flex items-center justify-center rounded-full border-2 border-gray-500 text-gray-500 focus:outline-none mt-3" onClick={signOut}>Sign out</button>
                    </div>
                </div>
            </div>
        </Transition>
